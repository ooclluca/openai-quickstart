...
# 将您的 api_key 设置为环境变量
set OPENAI_API_KEY=
python ai_translator/main.py --model_type OpenAIModel --openai_api_key %OPENAI_API_KEY% --file_format markdown --book tests/test.pdf --openai_model gpt-3.5-turbo -target_language xxx
```
